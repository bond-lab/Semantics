...
% \begin{frame}{Idioms and Metaphors}
% \begin{itemize}
...
\begin{frame}{We interpret words in \txx{context}}
...
\begin{frame}{All knowledge is context}
...
\begin{frame}{Context can complete fragments}
\begin{itemize}
...
%\begin{frame}{Mutual Knowledge}

% \end{frame}

%\begin{frame}{Formalizing Knowledge for Computers}
...
%\begin{frame}{What can computers do?}
% \MyLogo{}
% \begin{itemize}
...
%\begin{frame}{Anaphoric Reference}
...
\begin{frame}[allowframebreaks]{Gricean Maxims}
...
\begin{frame}[allowframebreaks]{An Example of implicature}
...
\begin{exe}
  ...
  \ex B: \eng{ Well, the school bus just left.}
...
\begin{frame}{Various Conversational Implicatures}
\begin{itemize}
...
\begin{frame}{Scalar Implicatures}
...
\begin{exe}
  \ex	\horn{\eng{all, most, many, some, few}}
  \ex	\horn{\eng{always, often, sometimes}}
\end{exe}
...
\begin{exe}
  \ex \eng{I've watched some of the new season.}
...
\begin{frame}{Flouting the maxims}
\begin{itemize}
...
\item Quality:
  \begin{exe}
    ...
    \ex \eng{I've got millions of bottles of wine in my cellar} \hfill hyperbole
    \ex \eng{Queen Victoria was made of iron} \hfill metaphor
    \ex \eng{I love it when you sing out of tune} \hfill irony or sarcasm
  \end{exe}
\item Manner: (to obscure from a third party:) \eng{Shall we get some I-C-E C-R-E-A-M?}

\end{itemize}

\end{frame}

\begin{frame}{What happens when we flout?}
\begin{itemize}
...
\item Mainly for politeness
  ...
  \ex {[Teacher to student?]}
    \begin{xlist}
      \ex \eng{Please give me a hand with this?}
      \ex \eng{Would you be so kind as to give me a hand with this?} \hfill ?
    \end{xlist}
  \end{exe}
...
\begin{frame}{Politeness and Face-Threatening Acts}

\begin{itemize}
\item[\PF{2}] \txx{Positive Face} desire to seem worthy and deserving of approval
  \\ \emp{self-worth}: I want you to like me/think well of me!
...
\item For more see \citet{Brown:Levinson:1987}

\end{itemize}
\end{frame}

\begin{frame}{Face Threatening Acts}
...
\begin{frame}{Face Saving Strategies} \MyLogo{Choice depends on social
...
\begin{frame}{An example of polite, indirect speech (gone wrong)}
...
The Big Bang Theory: \href{https://www.youtube.com/watch?v=fhv1dOae9MUAn}{The Apology Insufficiency (S4E7)}
\end{frame}


\section{Austin's Speech Act Theory}

\begin{frame}{Speech as Action}
\begin{itemize}
...
\item For more see \citet{Austin:1962}
\end{itemize}
...
\item It doesn't deal well with these
  \begin{exe}
    ...
    \ex \eng{How 'bout them niners?} \hfill (change the subject)
  \end{exe}
\end{itemize}

\end{frame}

\begin{frame}{Truth conditions in Czech?}
\begin{itemize}
\item The same issues arise in any language, e.g.\ Czech:
  \begin{exe}
    \ex \eng{Promiňte!} ``Excuse me!''
    \ex \eng{Dobrý den.} ``Hello.''
    \ex \eng{Na zdraví!} ``Cheers!''
    \ex \eng{Dobrou chuť!} ``Enjoy your meal!''
    \ex \eng{A co takhle to počasí?} ``What about this weather?'' \hfill (change the subject)
    \ex \eng{Dvě piva a svíčkovou, prosím.} ``Two beers and a svíčková, please.''
  \end{exe}
\item The last example could be analysed as a \txx{fragment} --- Czech case marking
  (accusative \eng{piva}, \eng{svíčkovou}) makes the elided \eng{[Chci]} `I want' highly
  recoverable --- or as a non-propositional order.
  % Languages differ in how strongly   they push one analysis over the other.
\item Note: \eng{Jak šla Sigma včera?} ``How did Sigma do yesterday?''  lacks the conventionalized topic-change force of \eng{How 'bout them niners?}
\end{itemize}
\end{frame}

\begin{frame}{Performative Utterances}
...
\begin{frame}{Felicity Conditions}
\begin{itemize}
...
\\ Given the correct \txx{felicity conditions}
  ...
  \item[B1] All participants must perform the procedure correctly
  \item[B2] \ldots  and completely
  \item[C1] The intention must be to do this act
...
\begin{frame}{Examples of Infelicities}
\begin{itemize} 
...
\begin{frame}{Explicit and Implicit Performatives}
\begin{itemize}
...
%\begin{frame}{Elements of Speech Acts}
% \begin{description}
...
\begin{frame}{Searle's speech act classification}
  \begin{description}
  ...
  \item For more see  \citet{Searle:1969}
  \end{description}
...
%\begin{frame}{Felicity Conditions for Promising}
% \MyLogo{Searle (1969)}
...
\begin{frame}{Indirect speech acts}
\MyLogo{}
 
\noindent \begin{tabular}[t]{lcll}
...
\begin{frame}{Literal and non-literal uses}
...
\begin{frame}{Felicity Conditions for Requesting}
...
\begin{frame}[allowframebreaks]{The big picture}
\begin{itemize} 
...
% \begin{frame}{What you have learned and are still learning}
...
\begin{frame}[allowframebreaks]{Acknowledgments and References}
...
defeasible & vyvratitelný \\
           &  neplatný za určitých podmínek \\
deixis & deixe \\
