...
\left\{ \begin{array}[c]{l}
    \mbox{\COL{purple}} \\  \mbox{\COL{pink}} \\ \mbox{\COL{orange}} \\  \mbox{\COL{gray}}
  \end{array} \right\} $}
\end{itemize}
...
See also: \url{http://wals.info/chapter/133}: Colour Terms
by Paul Kay and Luisa Maffi and \citep{Kay:Maffi:2000}
\end{frame}
