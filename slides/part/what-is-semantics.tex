...
the same word as the color of the sky.  Historically this color covered both green and blue ``grue'',
...
\begin{frame}{Verbing Wierds Language}
  \begin{center}
    \includegraphics[width=\textwidth]{img/verbing.jpg}
  \end{center}

From \textit{Calvin and Hobbes} by Bill Watterson (\textit{Homicidal Psycho Jungle Cat} (1994) ISBN 0836217691)
\bigskip
\begin{itemize}
\item We can change words from one part of speech to another, with a slight change in meaning, \ldots
\end{itemize}
