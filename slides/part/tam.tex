...
\begin{frame}{Tense, Aspect and Modality}
\begin{itemize}
\item  We need to distinguish grammatical expression from 
  ...
  \end{itemize}
\item  The relation between them is referred to as
  \begin{itemize}
...
knowledge.
\begin{exe}
  \ex \eng{You can drive this car} \cmm{You have the ability to}
\end{exe}
...
\item \txx{teleological} concerns achieving a goal
\end{itemize}
...
%\newcommand{\TIPA}[1]{\textipa{\mtcitestyle{#1}}}
 Some languages must show how you gained the evidence
\begin{itemize}
