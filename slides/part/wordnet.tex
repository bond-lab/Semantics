...
\begin{itemize}
\item We will use wordnet as a source of examples and inspiration
  
\item There is a good online interface here: \url{https://cygnet.maudslay.eu/}
...
\item [\ldots]
\end{itemize}
\item If you are interested in doing something with it, come and talk to me!
\end{itemize}
\end{frame}
