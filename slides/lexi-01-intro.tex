...
\begin{frame}{Overview}
  ...
  \item I will talk for about an hour, then we will work together
  \item Assessment
    \begin{itemize}
...
\input{part/self-intro}
\input{part/what-is-semantics}
\input{part/saw-a-kid} 
\input{part/referential-referring}
\input{part/close-reading}
\input{part/administrivia}
