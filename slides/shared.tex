...
\setmonofont{TeX Gyre Cursor} %  Fira Mono}
...
\xeCJKsetup{
  PunctStyle=plain,
  CJKspace=false,      % don't add space between CJK and Latin
  CJKglue=,           % no inter-CJK glue
  AutoFakeBold=false,
  AutoFakeSlant=false
}
...
\usepackage{xcolor}
 ...
 \newcommand{\con}[1]{\textup{\texttt{\color{blue}{\textbf{#1}}}}}
...
\newcommand{\Story}{The War with the Newts\xspace}
