...
\item Match the metonym with its type
  ...
  \begin{tabular}{lcl}
  a. The ham sandwich wants the bill.&~~~~~~~~~~& i. PART FOR WHOLE \\
b. She drank the whole bottle.&&ii. WHOLE FOR PART \\
c. Oxford published a new dictionary.&&iii. PRODUCER FOR PRODUCT \\
d. All hands on deck.&&iv. PLACE FOR INSTITUTION \\
e. The university raised tuition.&&v. OBJECT FOR USER \\
f. The suits approved the merger.&&vi. CONTAINER FOR CONTENT  \\
  \end{tabular}
\end{center}
\end{enumerate}
\end{document}
